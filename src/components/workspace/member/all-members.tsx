              ...
              <Popover>
                ...
                {canChangeMemberRole && (   
                  <PopoverContent className="p-0" align="end">
                    <Command>
                      <CommandInput disabled={isLoading} className="disabled:pointer-events-none" placeholder="Select new role..." />
                      <CommandList>
                        {isLoading ? (
                                ...
                                role.name!=="OWNER" && (  
                                  <CommandItem 
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                      {role.name==="ADMIN" && "Can view, create, edit tasks, project and manage settings."}
